...
class HomeController < ApplicationController
  ...
  def show
    ...
    if @mode == "stereo"
      ...
      @imgpath = "anaglyph_sarah_imgs/images/" + @file_name
    end
  ...
  def anaglyph_image_names
    Rails.cache.fetch("anaglyph_file_list", expires_in: 30.minutes) do
      return Dir.glob("#{Rails.public_path}/../app/assets/images/anaglyph_sarah_imgs/images/*").each{|str| str.gsub!("#{Rails.public_path}/../app/assets/images/anaglyph_sarah_imgs/images/","")}.sort
    end
  end
end
